...
RSpec.describe RecipeFood, type: :model do
  before(:each) do
    ...
    @r = @u.recipes.new(name: 'boiled egg', preparation_time: 2, cooking_time: 5, description: 'Put the egg in boiling water for about 5 minutes, slightly less if you like the yolk underdone', public: nil, user_id: @u.id)
