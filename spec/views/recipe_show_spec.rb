RSpec.describe 'Recipe show', type: :feature do
  before(:each) do
    ...
    @recipe = @test1.recipes.create(name: 'boiled egg', preparation_time: 2, cooking_time: 5,
                                    description: 'Put the egg in boiling water for about 5 minutes, slightly less if you like the yolk underdone',
                                    public: true)
