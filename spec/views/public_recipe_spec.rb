RSpec.describe 'Recipe show', type: :feature do
  before(:each) do
    ...
    @recipe1 = @test1.recipes.create(name: 'test food1', preparation_time: 2, cooking_time: 5,
                                     description: 'How to cook testfood1', public: true)
    @recipe2 = @test2.recipes.create(name: 'test food2', preparation_time: 2, cooking_time: 5,
                                     description: 'How to cook testfood2', public: true)
    @recipe3 = @test3.recipes.create(name: 'test food3', preparation_time: 2, cooking_time: 5,
                                     description: 'How to cook testfood3', public: true)
    @recipe4 = @test3.recipes.create(name: 'test food4', preparation_time: 2, cooking_time: 5,
                                     description: 'How to cook testfood4', public: false)
